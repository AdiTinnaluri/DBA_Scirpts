...
decode(r.STATUS_CODE, 'A','Waiting', 'B','Resuming', 'C','Normal', 'D','Cancelled', 'E','Error', 'F','Scheduled', 'G','Warning', 'H','On Hold', 'I','Normal'
...
AND r.actual_start_date >= (sysdate-100) --AND r.requested_by=22378
...
--and t.user_concurrent_program_name like 'UNITY Automatic Requisition Conversion Engine%'
and p.concurrent_program_name like '&Program_Short_name'
